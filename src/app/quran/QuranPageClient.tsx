  ...
  return (
    <div className="relative min-h-screen bg-ed-bg text-ed-fg font-sans antialiased selection:bg-ed-accent-soft selection:text-ed-fg">
      ...
      <main id="main-content" className="relative z-[1] overflow-hidden">
        ...
        {/* Sticky Filter Bar */}
        <div className="sticky top-16 z-30 border-y border-ed-rule bg-ed-bg/95 backdrop-blur-2xl">
          <div className="mx-auto flex max-w-[1160px] items-center gap-3 px-4 py-3 sm:px-7">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-[4px] border border-ed-rule bg-ed-surface py-2 pl-10 pr-10 text-sm text-ed-fg placeholder:text-ed-fg-muted transition-colors focus:border-ed-rule-strong focus:bg-ed-surface-strong focus:outline-none"
              />
              {query ? (
                <button
                  type="button"
                ...
                <div className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 hidden items-center gap-1 sm:flex">
                  <kbd className="rounded-[4px] border border-ed-rule bg-ed-surface px-1.5 py-0.5 font-mono text-[10px] text-ed-fg-muted">
                    /
                  </kbd>
                </div>
              )}
            ...
            <div
              className="flex shrink-0 rounded-[6px] border border-ed-rule bg-ed-surface p-1"
              role="group"
              ...
              >
                {viewMode === 'grid' && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-[4px] border border-ed-accent/40 bg-ed-accent/10"
        ...
        <div className="mx-auto max-w-[1160px] px-4 py-10 sm:px-7 sm:py-14">
          {filteredChapters.length === 0 ? (
            <div className="rounded-[12px] border border-dashed border-ed-rule bg-ed-surface px-6 py-24 text-center">
              ...
              <p
                className="mt-4 text-xl text-ed-fg-secondary"
                style={{ fontFamily: 'var(--font-source-serif), Georgia, serif' }}
              >
              ...
              <button
                type="button"
                onClick={() => setQuery('')}
                className="mt-4 text-sm font-medium text-ed-accent transition-colors hover:underline"
              >
                Clear filter
              </button>
            </div>
                  ...
                  {filteredChapters.map((chapter) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2 border-b border-ed-rule pb-2.5 mb-3">
                        <span className="font-mono text-xs tabular-nums text-ed-fg-muted transition-colors group-hover:text-ed-fg">
                      ...
                      <div className="min-w-0">
                        <h2
                          className="truncate text-sm sm:text-base font-semibold text-ed-fg transition-colors"
                          style={{ fontFamily: 'var(--font-source-serif), Georgia, serif' }}
                        >
                  ...
                  {filteredChapters.map((chapter) => (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        <span className="w-10 shrink-0 font-mono text-xs font-semibold tabular-nums text-ed-fg-muted transition-colors group-hover:text-ed-fg">
                          #{String(chapter.chapterNumber).padStart(3, '0')}
                        </span>
                      ...
                      <div className="flex items-center gap-5 shrink-0 text-xs">
                        <span
                          dir="rtl"
                          className="font-arabic text-base text-ed-fg-muted transition-colors group-hover:text-ed-fg"
                        >
                          {chapter.titleArabic}
                        </span>
