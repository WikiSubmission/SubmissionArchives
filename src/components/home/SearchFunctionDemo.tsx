...
export default function SearchFunctionDemo() {
    ...
    const qsImageSrc = getPublicAssetUrl('/content/audios/quran-studies/45 Quran Study From Roxana 445 Sura 40 By Rashad Firoz\'s Home Deja Vu Believers Usually 95 Yrs Old F%20QS45.jpg');
                    ...
                    <div className="relative space-y-3">
                            ...
                            <article className="soft-shell overflow-hidden">
                                <div className="grid grid-cols-[72px_1fr] gap-3 p-3 sm:grid-cols-[120px_1fr] sm:gap-4 sm:p-4">
                                    <div className="soft-panel relative aspect-video overflow-hidden bg-ed-bg">
                                        <Image src="/content/videos/thumbnails/old-message-new-messenger.jpg" alt="Old Message New Messenger" fill quality={60} className="object-cover" sizes="120px" />
                                    </div>
                                    <div className="min-w-0">
                                        <div className="flex flex-wrap items-center gap-1.5">
                        ...
                        <div className="search-demo-result-3">
                            <article className="soft-shell overflow-hidden">
                                <div className="grid grid-cols-[72px_1fr] gap-3 p-3 sm:grid-cols-[120px_1fr] sm:gap-4 sm:p-4">
                                    <div className="soft-panel relative aspect-video overflow-hidden bg-ed-bg">
                                        <Image src="/content/audios/messenger-audios/default.jpg" alt="Messenger Audio" fill quality={60} className="object-cover" sizes="120px" />
                                    </div>
                                    <div className="min-w-0">
                                        <div className="flex flex-wrap items-center gap-1.5">
