...
const VIDEO_SLIDES = [
    { src: '/content/videos/thumbnails/friday-sermon-universal-unity-through-devotion-to-god-alone.webp', category: 'Friday Sermon', title: '1987 Khutbah' },
    { src: '/content/videos/thumbnails/mathematical-miracle-of-quran.jpg', category: 'Instructional Program', title: 'Mathematical Miracle of the Quran' },
    { src: '/content/videos/thumbnails/friday-sermon-united-submitters-international-conference-1989.webp', category: 'Friday Sermon', title: 'Friday Sermons, 1989' },
    { src: '/content/videos/thumbnails/united-submitters-international-conference-final-speech-by-dr-rashad-khalifa-1989.webp', category: 'USI Conference', title: 'Final Speech — 1989 Conference' },
    { src: '/content/videos/thumbnails/essentials-of-submission-islam.jpg', category: 'Instructional Program', title: 'Essentials of Submission' },
    { src: '/content/videos/thumbnails/principles-of-contact-prayers-salat.jpg', category: 'Instructional Program', title: 'Contact Prayers (Salat)' },
];
