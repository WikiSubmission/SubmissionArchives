...
const FEATURED_PROGRAMS: VideoProgram[] = [
    ...
    {
        id: 'debate-dr-rashad-khalifa-ph-d-vs-sunni-scholars-1987',
        title: 'Debate: Dr. Rashad Khalifa vs Sunni Scholars (1987)',
        category: 'debate',
        ...
        summary: 'The historic debate in Tucson between Dr. Rashad Khalifa and Sunni scholars on the sufficiency of the Quran, the origins of prayer practices, and the testimony of faith.',
        chapters: [
            { time: '00:34', seconds: 34, title: 'One Message from All Messengers' },
            { time: '04:11', seconds: 251, title: 'The Quran as Fully Detailed' },
            { time: '06:47', seconds: 407, title: 'The Prayers Came from Abraham' },
            { time: '10:09', seconds: 609, title: 'The Crest Toothpaste Analogy' },
            { time: '16:02', seconds: 962, title: 'Abu Bakr Compiled Only the Quran' },
            { time: '36:32', seconds: 2165, title: 'No Distinction Among Messengers' },
        ],
        href: '/media/video-program/debate-dr-rashad-khalifa-ph-d-vs-sunni-scholars-1987',
    },
];
