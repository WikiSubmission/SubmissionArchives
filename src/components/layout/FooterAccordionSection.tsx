    ...
    return (
        <details ref={detailsRef} className="group border-b border-[#2A2928] sm:border-b-0" open>
            <summary
                ...
                className="flex cursor-pointer list-none items-center justify-between py-4 font-mono text-[11px] font-semibold uppercase tracking-[0.2em] text-[#6B6560] sm:cursor-default sm:border-b sm:border-[#2A2928] sm:pb-3 sm:pt-0 [&::-webkit-details-marker]:hidden"
            >
                {section.title}
