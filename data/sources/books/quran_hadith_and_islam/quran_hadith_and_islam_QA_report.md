# QA Report - Quran, Hadith, and Islam

- Source PDF: `Quran, Hadith, and Islam(1).pdf`
- PDF pages represented: **92 of 92**
- Blank/nearly blank pages recorded: **0**
- Pages with Arabic segments: **16**
- Arabic segments matched to canonical Quran verses: **11**
- Arabic segments retained as unverified OCR: **5**
- Mean English OCR confidence (where OCR was run): **85.64**
