# QA Report - ETERNITY - Screenplay

- Source PDF: `ETERNITY - Screenplay(1).pdf`
- PDF pages represented: **94 of 94**
- Blank/nearly blank pages recorded: **0**
- Pages with Arabic segments: **0**
- Arabic segments matched to canonical Quran verses: **0**
- Arabic segments retained as unverified OCR: **0**
- Mean English OCR confidence (where OCR was run): **90.65**
